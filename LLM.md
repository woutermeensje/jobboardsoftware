...
- Public job submissions can select an existing company profile from the tenant account or enter a new company name when the company is not listed. A job may also store its own uploaded company logo, falling back to the selected company profile logo when no new logo is uploaded.
