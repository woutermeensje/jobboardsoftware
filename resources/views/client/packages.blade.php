      ...
      <div class="dash-form-layout">
        <main class="dash-form-layout__main">
          <section class="dash-panel">
            <div class="dash-panel__head">
              <div>
                <h2>My packages</h2>
                <p>Create the packages employers can choose from when they submit a job.</p>
              </div>
            </div>
        ...
        <aside class="dash-form-layout__aside">
          <section class="dash-card dash-form-side">
            ...
            <p>Packages added here appear in the package selector on the tenant post-a-job form.</p>
          </section>
        </aside>
      </div>
      ...
      <section class="dash-panel">
        <div class="dash-panel__head">
          <div>
            ...
            <p>These packages are shown per environment on the public job submission form.</p>
          </div>
        </div>
